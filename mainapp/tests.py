...
class ShopTestCases(TestCase):
    ...
    def setUp(self) -> None:
        ...
        image = SimpleUploadedFile("smartphones_image.jpg", content=b'', content_type="image/jpg")
        self.smartphone = Product.objects.create(
            category=self.category,
            title="TestSmartphone",
            slug="test",
            image=image,
            price=Decimal('50000.00'),
        )
        self.customer = Customer.objects.create(user=self.user, phone='9999999999', address="Odessa")
    ...
    def test_response_from_add_to_cart_view(self):
        ...
        response = AddToCartView.as_view()(request, slug="test")
